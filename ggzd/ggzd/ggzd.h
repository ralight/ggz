 ...
 * Date: 3/8/00
 * Desc: Server defines
 * $Id: ggzd.h 10824 2009-01-07 19:05:12Z josef $
 *
...
typedef enum {
	GGZ_REGISTRATION_OPEN,
	GGZ_REGISTRATION_CONFIRM,
	GGZ_REGISTRATION_CONFIRMLATER,
	GGZ_REGISTRATION_CLOSED
} GGZRegistrationPolicy;
