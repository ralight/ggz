#ifndef ZONE_PROTOCOLS_H
#define ZONE_PROTOCOLS_H
/* because of:
	../ggz/protocols.h:27: conflicting types for `enum {anonymous} REQ_LOGIN_NEW'
	../ggz/protocols.h:27: previous declaration as `enum UserToControl REQ_LOGIN_NEW'.
*/
