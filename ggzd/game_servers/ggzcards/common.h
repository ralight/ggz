 ...
 * $Id: common.h 2647 2001-11-04 03:50:54Z jdorje $
 *
...
/* void handle_quit_event(int event, void* data); */
...
void *alloc(int size);
void *alloc2(int num, int len);	/* A double array, all linked up as desired */
