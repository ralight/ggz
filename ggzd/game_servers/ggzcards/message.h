 ...
 * $Id: message.h 2418 2001-09-09 03:42:21Z jdorje $
 *
...
void send_last_hand();		/* sends a listing of the cards in the last
				   hand */
void send_last_trick();		/* sends a listing of the cards on the last
				   trick */
void init_cumulative_scores();	/* initialized the "cumulative scores"
				   tracking */
void update_cumulative_scores();	/* updates the "cumulative scores",
					   and sends new one */
void send_bid_history();	/* sends the bid history from the current
				   hand */
