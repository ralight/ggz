 ...
 * $Id: message.c 3572 2002-03-16 15:01:44Z jdorje $
 *
...
void init_cumulative_scores()
{
	...
	/* Cumulative scores are initialized at the start, and the array can
	   carry over from game to game.  We only need to rest the count. */
	c_score_count = 0;
