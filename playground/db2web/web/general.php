...
if ($type == "player") :
	if ($lookup == $ggzuser) :
		echo "<img src='ggzicons/players/you.png' width=32 height=32>\n";
	else :
		echo "<img src='ggzicons/players/player.png' width=32 height=32>\n";
	endif;
elseif ($type == "game") :
	echo "<img src='ggzicons/games/$lookup.png' width=32 height=32>\n";
endif;
