...
public class TableLayoutTest {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int cardIndex = 0; cardIndex < 13; cardIndex++) {
			Sprite sprite = new Sprite(new Card(
					(Face) Face.values()[cardIndex + 1], Suit.SPADES),
		...
		for (int cardIndex = 0; cardIndex < 13; cardIndex++) {
			Sprite sprite = new Sprite(new Card(
					(Face) Face.values()[cardIndex + 1], Suit.HEARTS),
					SwingConstants.LEFT);
			table.add(sprite, new TableConstraints(
		...
		for (int cardIndex = 0; cardIndex < 13; cardIndex++) {
			Sprite sprite = new Sprite(new Card(
					(Face) Face.values()[cardIndex + 1], Suit.CLUBS),
					SwingConstants.TOP);
			table.add(sprite, new TableConstraints(
		...
		for (int cardIndex = 0; cardIndex < 13; cardIndex++) {
			Sprite sprite = new Sprite(new Card(
					(Face) Face.values()[cardIndex + 1], Suit.DIAMONDS),
