...
public class SeatAllocationDialog extends JDialog implements ItemListener {
	private static final String JOIN_ME = "Join me!";

	private static final String I_PLAY_ALONE = "I play alone...";
	...
	public SeatAllocationDialog(Frame frame, String title, GameType gameType) {
		...
		if (isSoloPlayPossible) {
			...
			soloPlayButton = new JRadioButton("Play against Computer");
			soloPlayButton.addItemListener(this);
			multiPlayButton = new JRadioButton(
					"Start a new game that others can join");
		...
		tableDescriptionLabel = new JLabel(
				"Short message that will be shown when the game is listed.");
