...
public class Module {
    ...
    /* List of modules */
    private static ArrayList<Module> module_list = new ArrayList<Module>(1);
    ...
    static {
        ...
        _add(new Module("GGZCards", "0.0.7", "GGZCards", "3", "Author",
                "Java", "url", "ggz.cards.GamePanel", "/ggz/ui/images/euchre.gif", "help_path"));
        _add(new Module("GGZCards-Spades", "0.0.7", "GGZCards", "3", "Author",
                "Java", "url", "ggz.cards.GamePanel", "/ggz/ui/images/spades.gif", "help_path"));
        _add(new Module("GGZCards-LaPocha", "0.0.7", "GGZCards", "3", "Author",
                "Java", "url", "ggz.cards.GamePanel", "/ggz/ui/images/pocha.gif", "help_path"));
        // 42 is played with Dominoes and is not supported.
        //_add(new Module("GGZCards-FortyTwo", "0.0.7", "GGZCards", "3", "Author",
        //        "Java", "url", "ggz.cards.GamePanel", "/ggz/ui/images/42.gif", "help_path"));
        _add(new Module("GGZCards-Bridge", "0.0.7", "GGZCards", "3", "Author",
        ...
        _add(new Module("GGZCards-Hearts", "0.0.7", "GGZCards", "3", "Author",
                "Java", "url", "ggz.cards.GamePanel", "/ggz/ui/images/hearts.gif", "help_path"));
    }
    ...
    private static int _get_num_by_type(String game, String engine,
        ...
        for (int i = 0; i < module_list.size(); i++) {
            Module module = module_list.get(i);
    ...
    private static Module _get_nth_by_type(String game, String engine,
        ...
        return index > -1 ? module_list.get(index) : null;
