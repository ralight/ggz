...
GtkWidget*
create_options_dialog (GdkColor *_back_color, GdkColor *_last_color)
{
  ...
  gtk_box_pack_start (GTK_BOX (dialog_vbox1), bg_frame, FALSE, TRUE, 0);
  ...
  color_radio = gtk_radio_button_new_with_label (bg_mode_group, ("Background color"));
  bg_mode_group = gtk_radio_button_group (GTK_RADIO_BUTTON (color_radio));
  gtk_widget_set_name (color_radio, "color_radio");
  gtk_widget_ref (color_radio);
  g_object_set_data_full(G_OBJECT (dialog1), "color_radio", color_radio,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  pixmap_radio = gtk_radio_button_new_with_label (bg_mode_group, ("Background Pixmap"));
  bg_mode_group = gtk_radio_button_group (GTK_RADIO_BUTTON (pixmap_radio));
  gtk_widget_set_name (pixmap_radio, "pixmap_radio");
  gtk_widget_ref (pixmap_radio);
  g_object_set_data_full(G_OBJECT (dialog1), "pixmap_radio", pixmap_radio,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (dialog1), "back_button", back_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (dialog1), "pixmap_label", pixmap_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (dialog1), "last_button", last_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data(G_OBJECT (dialog1), "dialog_action_area1", dialog_action_area1);
  ...
  g_object_set_data_full(G_OBJECT (dialog1), "cancel_button", cancel_button,
                            (GtkDestroyNotify) gtk_widget_unref);
...
create_colorselectiondialog (GdkColor *col)
{
  ...
  g_object_set_data(G_OBJECT (colorselectiondialog1), "colorselectiondialog1", colorselectiondialog1);
  ...
  g_object_set_data(G_OBJECT (colorselectiondialog1), "ok_button1", ok_button1);
  ...
  g_object_set_data(G_OBJECT (colorselectiondialog1), "cancel_button1", cancel_button1);
...
void prepare_data(GtkButton *button, gchar *data) {
  ...
  gtk_color_selection_get_color( GTK_COLOR_SELECTION (GTK_COLOR_SELECTION_DIALOG(color_sel)->colorsel), color_val);
