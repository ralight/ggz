...
create_dlg_opt (void)
{
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlg_opt), "vbox1", vbox1,
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlg_opt), "table1", table1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlg_opt), "opt_spin_y", opt_spin_y,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlg_opt), "opt_spin_x", opt_spin_x,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlg_opt), "hbox2", hbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_signal_connect (GTK_OBJECT (dlg_opt), "delete_event",
                      GTK_SIGNAL_FUNC (on_dlg_opt_delete_event),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (opt_btn_ok), "clicked",
                      GTK_SIGNAL_FUNC (on_opt_btn_ok_clicked),
                      NULL);
  gtk_signal_connect_object (GTK_OBJECT (opt_btn_ok), "clicked",
