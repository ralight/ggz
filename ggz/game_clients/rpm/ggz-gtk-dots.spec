...
Summary: GGZ Connect the Dots for Gtk 1.2
Name: ggz-gtk-dots
Version: 0.0.2
Release: 1
Copyright: GPL
Group: Amusements/Games
Source: http://download.sourceforge.net/GGZ/ggz-gtk-dots-0.0.2.tar.gz
...
%description
A Connect the Dots client for the Gnu Gaming Zone Gtk user interface.
...
cp dots/module.dsc $RPM_BUILD_ROOT/usr/share/ggz/ggz-config/gtk-dots.dsc
...
ggz-config --install --fromfile=/usr/share/ggz/ggz-config/gtk-dots.dsc --force


%preun
# Run ggz-config to uninstall the game
ggz-config --remove --fromfile=/usr/share/ggz/ggz-config/gtk-dots.dsc
