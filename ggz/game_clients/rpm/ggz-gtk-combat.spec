...
Summary: GGZ Combat for Gtk 1.2
Name: ggz-gtk-combat
Version: 1.0
Release: 1
Copyright: GPL
Group: Amusements/Games
Source: http://download.sourceforge.net/GGZ/ggz-gtk-combat-1.0.tar.gz
...
%description
A Combat (Stratego-like) client for the Gnu Gaming Zone Gtk user interface.
...
cp combat/module.dsc $RPM_BUILD_ROOT/usr/share/ggz/ggz-config/gtk-combat.dsc
...
ggz-config --install --fromfile=/usr/share/ggz/ggz-config/gtk-combat.dsc --force


%preun
# Run ggz-config to uninstall the game
ggz-config --remove --fromfile=/usr/share/ggz/ggz-config/gtk-combat.dsc
