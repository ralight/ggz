...
Summary: GGZ Spades for Gtk 1.2
Name: ggz-gtk-netspades
Version: 0.0.2
Release: 1
Copyright: GPL
Group: Amusements/Games
Source: http://download.sourceforge.net/GGZ/ggz-gtk-netspades-0.0.2.tar.gz
...
%description
A Spades client for the Gnu Gaming Zone Gtk user interface.
...
cp spades/module.dsc $RPM_BUILD_ROOT/usr/share/ggz/ggz-config/gtk-spades.dsc
...
ggz-config --install --fromfile=/usr/share/ggz/ggz-config/gtk-spades.dsc --force


%preun
# Run ggz-config to uninstall the game
ggz-config --remove --fromfile=/usr/share/ggz/ggz-config/gtk-spades.dsc
