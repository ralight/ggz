...
Summary: GGZ Reversi for Gtk 1.2
Name: ggz-gtk-reversi
Version: 0.1
Release: 1
Copyright: GPL
Group: Amusements/Games
Source: http://download.sourceforge.net/GGZ/ggz-gtk-reversi-0.1.tar.gz
...
%description
A Reversi client for the Gnu Gaming Zone Gtk user interface.
...
cp reversi/module.dsc $RPM_BUILD_ROOT/usr/share/ggz/ggz-config/gtk-reversi.dsc
...
ggz-config --install --fromfile=/usr/share/ggz/ggz-config/gtk-reversi.dsc --force


%preun
# Run ggz-config to uninstall the game
ggz-config --remove --fromfile=/usr/share/ggz/ggz-config/gtk-reversi.dsc
