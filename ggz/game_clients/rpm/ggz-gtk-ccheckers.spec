...
Summary: GGZ Chinese Checkers for Gtk 1.2
Name: ggz-gtk-ccheckers
Version: 0.0.1
Release: 1
Copyright: GPL
Group: Amusements/Games
Source: http://download.sourceforge.net/GGZ/ggz-gtk-ccheckers-0.0.1.tar.gz
...
%description
A Chinese Checkers client for the Gnu Gaming Zone Gtk user interface.
...
cp chinese-checkers/module.dsc $RPM_BUILD_ROOT/usr/share/ggz/ggz-config/gtk-chinese-checkers.dsc
...
ggz-config --install --fromfile=/usr/share/ggz/ggz-config/gtk-chinese-checkers.dsc --force


%preun
# Run ggz-config to uninstall the game
ggz-config --remove --fromfile=/usr/share/ggz/ggz-config/gtk-chinese-checkers.dsc
