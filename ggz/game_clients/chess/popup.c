...
create_draw_dialog (void)
{
  ...
  g_object_set_data(G_OBJECT (draw_dialog), "draw_dialog", draw_dialog);
  gtk_window_set_title (GTK_WINDOW (draw_dialog), _("Do you want do draw the game ?"));

  dialog_vbox1 = GTK_DIALOG (draw_dialog)->vbox;
  g_object_set_data(G_OBJECT (draw_dialog), "dialog_vbox1", dialog_vbox1);
  ...
  g_object_set_data_full(G_OBJECT (draw_dialog), "draw_message", draw_message,
  ...
  g_object_set_data(G_OBJECT (draw_dialog), "dialog_action_area1", dialog_action_area1);
  gtk_widget_show (dialog_action_area1);
  gtk_container_set_border_width (GTK_CONTAINER (dialog_action_area1), 10);

  hbuttonbox1 = gtk_hbutton_box_new ();
  gtk_widget_ref (hbuttonbox1);
  g_object_set_data_full(G_OBJECT(draw_dialog), "hbuttonbox1", hbuttonbox1,
			 (GtkDestroyNotify) gtk_widget_unref);
...
create_clock_dialog (void)
{
  ...
  gtk_window_set_transient_for(GTK_WINDOW(clock_dialog),
			       GTK_WINDOW(main_win));
  g_object_set_data(G_OBJECT (clock_dialog), "clock_dialog", clock_dialog);
  gtk_window_set_title (GTK_WINDOW (clock_dialog),
			_("Select your clock option"));

  dialog_vbox2 = GTK_DIALOG (clock_dialog)->vbox;
  g_object_set_data(G_OBJECT (clock_dialog), "dialog_vbox2", dialog_vbox2);
  ...
  time_option_group = gtk_radio_button_get_group(GTK_RADIO_BUTTON(no_clock));
  gtk_widget_ref (no_clock);
  g_object_set_data_full(G_OBJECT (clock_dialog), "no_clock", no_clock,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (clock_dialog), "server_clock", server_clock,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (clock_dialog), "server_lag_clock", server_lag_clock,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (clock_dialog), "client_clock", client_clock,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data(G_OBJECT (clock_dialog), "dialog_action_area2", dialog_action_area2);
  gtk_widget_show (dialog_action_area2);
  gtk_container_set_border_width (GTK_CONTAINER (dialog_action_area2), 10);

  hbuttonbox2 = gtk_hbutton_box_new ();
  gtk_widget_ref (hbuttonbox2);
  g_object_set_data_full(G_OBJECT (clock_dialog), "hbuttonbox2", hbuttonbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  g_object_set_data_full(G_OBJECT (clock_dialog), "send_option", send_option,
                            (GtkDestroyNotify) gtk_widget_unref);
...
create_promote_dialog (void)
{
  ...
  g_object_set_data(G_OBJECT (promote_dialog), "promote_dialog", promote_dialog);
  ...
  g_object_set_data(G_OBJECT (promote_dialog), "dialog_vbox3", dialog_vbox3);
  ...
  promote_group = gtk_radio_button_get_group(GTK_RADIO_BUTTON(queen));
  ...
  promote_group = gtk_radio_button_get_group(GTK_RADIO_BUTTON(bishop));
  ...
  promote_group = gtk_radio_button_get_group(GTK_RADIO_BUTTON(knight));
  ...
  g_object_set_data(G_OBJECT (promote_dialog), "dialog_action_area3", dialog_action_area3);
