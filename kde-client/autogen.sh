...
(perl --version) < /dev/null > /dev/null 2>&1 || {
  echo
  echo "**Error**: Missing \`perl'. You need perl to extract"
  echo "the meta objects information from the header files."
  echo "This restriction does only apply to CVS sources."
  echo "Get perl from http://www.perl.com."
  DIE=1
}
