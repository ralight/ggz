...
dnl    This file has been modified:
dnl    - kde_datadir is now accompaigned by kde_datadir_c,
dnl      which can be used for config.h (unquoted)
dnl    - bugfix: removed --build option from libtool call
dnl    Josef Spillner, February 2001

dnl    The original version of this file is part of the KDE libraries/packages
...
if test "$1" = "default"; then
  ...
  if test -z "$kde_datadir"; then
    ...
    kde_datadir_c='${prefix}/share/apps'
  fi
